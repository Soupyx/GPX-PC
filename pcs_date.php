...
$pcs = [
    ...
    'Gamer - NVIDIA' => [
        [
            ...
            'components' => [
                ...
                'Stockage : Silicon Power SSD 3D NAND A55 SLC, 1To (SATA III)',
                'Alimentation : MSI MAG A750GL PCIE5',
            ...
            'main_specs' => [
                ...
                'Alimentation : MSI MAG A750GL',
                'Boîtier : MSI MAG FORGE 100M',
            ],
            'case_link' => 'https://fr.msi.com/PC-Case/MAG-FORGE-100M',
        ],
        [
            ...
            'components' => [
                ...
                'Stockage : Samsung SSD 990 EVO Plus – 1 To',
                'Alimentation : MSI MAG A650GL – 650 W Gold modulaire',
                'Boîtier : MSI MAG FORGE 100M',
            ],
            'main_specs' => [
        ...
        [
            ...
            'components' => [
                ...
                'Stockage : Samsung SSD 990 EVO Plus - 1 To',
                'Alimentation : Corsair RM750e (2025) - Noir',
                'Boîtier : AeroCool Dryft V2'
            ],
            'main_specs' => [
                ...
                'Stockage : SSD NVMe 1To',
                'Alimentation : Corsair RM750e',
                'Boîtier : AeroCool Dryft V2'
            ],
            'case_link' => 'https://aerocool.io/product/dryft/',
        ],
        [
            ...
            'components' => [
                ...
                'Stockage : Samsung SSD 990 EVO Plus - 2 To',
                'Alimentation : MSI MAG A850GL PCIE5',
                'Boîtier : NZXT H6 Flow RGB - Noir'
            ],
            'main_specs' => [
                'Processeur : Intel Core Ultra 7 265KF',
                'Carte graphique : RTX 5070',
                'RAM : 2x16Go DDR5',
                'Carte mère : MSI PRO B860-P WIFI',
                'Refroidissement : Arctic Liquid Freezer III Pro 280',
                'Stockage : SSD NVMe 2To',
                'Alimentation : MSI MAG A850GL',
                'Boîtier : NZXT H6 Flow RGB'
            ],
            'case_link' => 'https://nzxt.com/fr-intl/products/h6-flow-rgb',
        ],
        [
            ...
            'components' => [
                ...
                'RAM : Kingston Fury Beast RGB 2 x 16 Go DDR5 6000 MHz CL30',
                'Carte mère : Asus TUF GAMING B650-E WIFI',
                'Refroidissement : Arctic Liquid Freezer III Pro 360 ARGB - Noir',
                'Stockage : Samsung 990 PRO - 2 To',
            ...
            'case_link' => 'https://www.coolermaster.com/en-global/products/masterbox-600/',
        ],
        [
            ...
            'components' => [
                ...
                'Alimentation : Asus ROG Strix 1000P - Noir',
                'Boîtier : NZXT H9 Flow RGB+ Noir',
            ],
            'main_specs' => [
                'Processeur : Ryzen 9 9950X3D',
                'Carte graphique : RTX 5080',
                'RAM : 2x32Go DDR5',
                'Carte mère : Asus ROG STRIX X870E-E GAMING WIFI',
                'Refroidissement : ASUS Ryujin III 360 + Thermaltake View 380 TG',
                'Stockage : SSD NVMe 2To',
                'Alimentation : Asus ROG Strix 1000P - Noir',
                'Boîtier : NZXT H9 Flow RGB+ Noir'
            ],
            'case_link' => 'https://nzxt.com/fr-intl/products/h9-flow-rgb-plus',
        ],
    ],
    ...
    'Gamer - AMD' => [
        ...
        [
            ...
            'main_specs' => [
                'Processeur : Ryzen 5 9600X',
                'Carte graphique : RX 9060 XT 16Go',
                'RAM : 2x16Go DDR5',
                'Carte mère : MSI B850M GAMING PLUS',
                'Refroidissement : be quiet! Pure Rock Pro 3',
                'Stockage : SSD NVMe 1To',
    ...
    'Streaming / Montage / IA / Rendu 3D' => [
        ...
        [
            ...
            'components' => [
                ...
                'Stockage : Samsung 9100 PRO avec dissipateur - 2 To',
                'Alimentation : be quiet! Pure Power 13 M 1000W',
                'Boîtier : Cooler Master MasterBox 600'
            ],
            'main_specs' => [
                'Processeur : Intel Core Ultra 7 265KF',
        ...
        [
            ...
            'main_specs' => [
                ...
                'Stockage : SSD NVMe 4To',
                'Refroidissement : Arctic Liquid Freezer III Pro 420',
                'Alimentation : MSI MAG A1250GL',
    ...
    'Bureautique' => [
        [
            ...
            'components' => [
                ...
                'RAM : G.Skill Aegis DDR4 8 Go 3200 MHz CAS 16',
                'Carte mère : Gigabyte B760M H DDR4',
                'Refroidissement : Refroidissement d\'origine',
                'Stockage : Silicon Power SSD 3D NAND A55 SLC, 500Go (SATA III)',
                'Alimentation : be quiet! System Power 11 450W',
            ...
            'main_specs' => [
                ...
                'Carte graphique : Intel UHD intégrée',
                'RAM : 2x4Go DDR4',
                'Carte mère : Gigabyte B760M H',
                'Refroidissement : Refroidissement d\'origine',
                'Stockage : SSD SATA III 500Go',
                'Alimentation : be quiet! System Power 11 450W',
                'Boîtier : AeroCool CS-109'
            ],
            'case_link' => 'https://aerocool.io/product/cs-109/',
        ],
        [
        ...
        [
            ...
            'components' => [
                ...
                'Carte graphique : Intel UHD intégrée',
                'RAM : Corsair Vengeance Black - 2 x 8 Go DDR5 5200 MHz CL40',
                'Carte mère : Gigabyte B760M DS3H AX',
                'Refroidissement : Refroidissement d\'origine',
                'Stockage : Silicon Power SSD 3D NAND A55 SLC, 1To (SATA III)',
                'Alimentation : be quiet! System Power 11 450W',
            ...
            'case_link' => 'https://www.coolermaster.com/en-global/products/n200/',
        ],
    ],
];
