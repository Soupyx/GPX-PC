...
<head>
  ...
  <title>Contact – GPX PC | Assemblage & Réparation PC en France</title>
  <meta name="description"
    content="Besoin d’un renseignement sur nos services de montage ou réparation de PC à Marseille ? GPX PC assemble vos ordinateurs et les livre partout en France.">
  ...
  <style>
    ...
    html, body {
      ...
      padding: 0;
      height: 100%;
      overflow-y: scroll; /* Force la barre verticale */
    }
  </style>
</head>
...
<body class="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100 transition-colors duration-500">
  ...
  <?php include 'footer.php'; ?> <!-- ✅ Footer dynamique -->
